...
import { Calendar, User, ArrowLeft, CheckCircle2, Send, Clock, XCircle } from "lucide-react"
...
export default function JobDetailsPage() {
        ...
        async function loadData() {
            ...
            try {
                ...
                if (role === "FREELANCER" && userId) {
                    ...
                    if (appliedApp) {
                        setIsApplied(true)
                        // Pegamos o status real que veio do backend e atualizamos o estado
    ...
    async function handleApply() {
        ...
        try {
            ...
            setIsApplied(true)
            setApplicationStatus("PENDING") // Força o status inicial após candidatar
