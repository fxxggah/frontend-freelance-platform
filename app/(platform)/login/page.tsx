    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-[440px] relative animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-[950] text-slate-900 tracking-tighter">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 sm:p-10 border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500 mt-1 font-medium">Acesse sua conta para gerenciar seus jobs.</p>
          </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-slate-500 font-medium text-sm">
              Não tem uma conta?{" "}
              <Link href="/register" className="text-emerald-600 font-bold hover:text-emerald-700 transition-colors underline-offset-4 hover:underline">
                Criar conta agora
              </Link>
            </p>
          </div>
        ...
        <p className="text-center mt-8 text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">
          Ambiente Seguro ClickJob <Sparkles className="inline-block w-3 h-3 ml-1" />
        </p>
      </div>
    </div>
  )
